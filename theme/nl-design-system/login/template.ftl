...
<head>
    ...
    <title>${msg("doLogIn")} ${properties.organizationName} - ${realm.displayName}</title>
    <link rel="icon" href="${url.resourcesCommonPath}/assets/images/favicon/icon.svg" />
      ...
      <div class="rvo-logo rvo-header__logo-img">
        <div class="rvo-logo__emblem">
          <svg
            ...
            role="img"
          >
            <title>Logo ${properties.organizationName}</title>
            <rect
              x="0"
              y="-12"
        ...
        <div class="rvo-logo__wordmark">
          <p class="rvo-logo__title">${properties.organizationName}</p>
        </div>
      </div>
    </div>
  </header>
                ...
                <div class="language-dropdown">
                  ...
                  <div class="language-dropdown-content">
                    ...
                    <#list locale.supported as l>
                      <a id="language-${i}" href="${l.url}">${l.label}</a>
                      <#assign i++>
                    </#list>
                  </div>
                </div>
          ...
          <div class="rvo-form">
            ...
            <#if !(auth?has_content && auth.showUsername() && !auth.showResetCredentials())>
                <#if displayRequiredFields>
                  ...
                  <h1 class="utrecht-heading-1"><#nested "header"></h1>
                <#else>
                  <h1 class="utrecht-heading-1"><#nested "header"></h1>
                </#if>
            <#else>
